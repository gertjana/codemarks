...
use crate::{Todo, load_global_config, load_global_projects, save_global_projects};

pub fn scan_directory(directory: &Path, ignore_patterns: &[String]) -> Result<usize, Box<dyn std::error::Error>> {
